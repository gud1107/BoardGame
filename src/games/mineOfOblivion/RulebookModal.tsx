    ...
    <Overlay title="💣 망각의 지뢰 룰북" onClose={onClose} wide>
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        ...
        <section>
          ...
          <p className="mt-1.5 text-xs text-white/40 light:text-slate-500">
            각자 가림판 뒤에서 지뢰 {MINES_PER_PLAYER}개를 비밀리에 매설합니다. 보물 칸과 두 플레이어의{" "}
            <span className="text-white/60 light:text-slate-600">안전구역(본인·상대 시작 칸 모두)</span>에는 매설할 수 없습니다 —
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">내 턴에 하는 일</h3>
          <div className="rounded-xl border border-white/10 light:border-slate-200 bg-white/5 light:bg-slate-900/5 p-3">
            <p className="mb-1 font-medium text-white light:text-slate-900">🧭 8방향 1칸 이동</p>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">도착 칸 판정</h3>
          <div className="grid gap-2 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-white/10 light:border-slate-200 bg-white/5 light:bg-slate-900/5 p-3">
              <p className="mb-1 font-medium text-white/70 light:text-slate-700">⬜ 기답사 칸</p>
              <p className="text-xs text-white/60 light:text-slate-600">본인 또는 상대가 이미 한 번이라도 밟은 칸이면 0점이며, 마찬가지로 즉시 다음 차례로 넘어갑니다.</p>
            </div>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">보물 순차 점수제</h3>
          <p className="text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">승리 조건</h3>
          <p className="text-white/70 light:text-slate-700">보물 3개가 모두 획득되는 즉시 게임이 종료되며, 총점이 더 높은 플레이어가 승리합니다. 총점이 같으면 무승부입니다.</p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">블러핑 &amp; 추리 팁</h3>
