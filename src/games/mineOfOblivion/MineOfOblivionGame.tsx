...
export default function MineOfOblivionGame({ onComplete }: PlayableGameProps) {
  ...
  if (phase === "choose") {
    return withGuard(
      <div className="flex flex-col items-center gap-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#1a0a0e] via-[#12070a] to-black p-8 text-center">
        <span className="text-4xl">💣</span>
        <h2 className="text-lg font-bold text-white">망각의 지뢰 온라인 대전</h2>
