...
export default function MineOfOblivionGame({ onComplete }: PlayableGameProps) {
  ...
  if (phase === "choose") {
    return withGuard(
      <RulebookGate
        gameId="mine-of-oblivion"
        containerClassName="border-white/10 bg-gradient-to-b from-[#1a0a0e] via-[#12070a] to-black"
        icon="💣"
        title="망각의 지뢰 온라인 대전"
  ...
  if (phase === "enter-name") {
    return withGuard(
      <div className="flex flex-col gap-4 rounded-2xl border border-white/10 bg-gradient-to-b from-[#1a0a0e] via-[#12070a] to-black p-6">
  ...
  if (phase === "connecting" || phase === "waiting") {
    return withGuard(
      <div className="flex flex-col items-center gap-5 rounded-2xl border border-white/10 bg-gradient-to-b from-[#1a0a0e] via-[#12070a] to-black p-8 text-center">
        {phase === "connecting" ? (
