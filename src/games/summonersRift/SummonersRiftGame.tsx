...
import { applyAction, computeRankings, MAX_PLAYERS, MIN_PLAYERS, startGame, type EngineAction, type SeatIndex, type SummonersRiftState } from "./engine";
...
export default function SummonersRiftGame({ onComplete }: PlayableGameProps) {
  ...
  function sendGameStart() {
    ...
    channelRef.current?.send({ type: "broadcast", event: "game-start", payload: { seed: randomSeed(), playerCount: playerCountRef.current } });
  }
