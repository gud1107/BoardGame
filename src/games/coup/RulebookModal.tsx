      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-700">
            ...
            <span className="text-amber-300 light:text-amber-700">그 즉시 완전히 탈락</span>하며, 최후까지 살아남은 단 1명이 즉시 최종 승자가 됩니다.
          </p>
        </section>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">내 턴 — 7가지 중 택 1</h3>
            ...
            <table className="w-full min-w-[480px] border-collapse text-xs">
              ...
              <tbody>
                {[
                  ...
                  <tr key={name} className="border-t border-white/10 light:border-slate-200">
                    <td className="px-2 py-1.5 font-semibold whitespace-nowrap text-white/80 light:text-slate-700">{name}</td>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">의심(Challenge) &amp; 방어(Counter)</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">⚠️ 단판 승부 대형 사고 (Double Kill)</h3>
