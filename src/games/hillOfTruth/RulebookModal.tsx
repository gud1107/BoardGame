  ...
  return (
    <Overlay title="📖 진실의 고개 룰북" onClose={onClose} wide>
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">시나리오 구성</h3>
        ...
        <section className="rounded-xl border border-cyan-300/20 bg-cyan-400/5 p-3 light:border-cyan-300 light:bg-cyan-50">
          <h3 className="mb-1.5 text-xs font-semibold tracking-wide text-cyan-200/90 uppercase light:text-cyan-800">🎚️ 난이도 3단계 (방 생성 시 선택)</h3>
          <ul className="list-disc space-y-1.5 pl-4 text-xs text-white/70 light:text-slate-700">
            <li>
          ...
          <p className="mt-2 break-keep text-[11px] text-white/50 light:text-slate-500">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">내 턴에 하는 행동</h3>
          ...
          <p className="mt-2 text-xs text-white/50 light:text-slate-500">순서는 참가자 순번대로 돌아가며(라운드 로빈), 자기 턴에만 행동할 수 있습니다.</p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">딜러의 3색 신호등 판정</h3>
          <ul className="list-disc space-y-1.5 pl-4 text-white/70 light:text-slate-600">
        ...
        <section className="rounded-xl border border-emerald-300/20 bg-emerald-400/5 p-3 light:border-emerald-300 light:bg-emerald-50">
          <h3 className="mb-1.5 text-xs font-semibold tracking-wide text-emerald-200/90 uppercase light:text-emerald-800">승리 &amp; 오답 페널티 (구버전과의 차이)</h3>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">🗂️ 수사 노트 (분석 도구)</h3>
          <p className="text-white/70 light:text-slate-600">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">🟡 노란불 복기 리포트</h3>
          <p className="text-white/70 light:text-slate-600">
        ...
        <section className="rounded-xl border border-amber-300/20 bg-amber-400/5 p-3 light:border-amber-300 light:bg-amber-50">
          <h3 className="mb-1.5 text-xs font-semibold tracking-wide text-amber-200/90 uppercase light:text-amber-800">참고</h3>
