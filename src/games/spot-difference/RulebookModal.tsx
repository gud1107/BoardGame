      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-600">
            ...
            <span className="text-amber-300 light:text-amber-600">틀린 곳의 총합(누적 개수)</span>으로 승패를 가릅니다 — 번갈아
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">오답 페널티</h3>
          <p className="text-white/70 light:text-slate-600">
            틀린 위치를 클릭하면 <span className="text-rose-300 light:text-rose-600">2초간</span> 내 클릭이 잠깁니다. 팀원이 함께
            찾는 게임이니 신중하게 클릭하세요.
          </p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">힌트</h3>
          <p className="text-white/70 light:text-slate-600">
            팀마다 힌트를 <span className="text-amber-300 light:text-amber-600">2회</span> 사용할 수 있습니다. 힌트를 쓰면 아직
