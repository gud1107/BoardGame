      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-600">
            모든 플레이어는 카드 1장을 <span className="text-amber-300 light:text-amber-700">자신은 보지 못하게</span> 이마에 붙입니다. 남의 카드는
            전부 보이지만 내 카드만은 숨겨진 채, 테이블 전체 카드 숫자의 합을 두고 블러핑과 배팅을 겨룹니다.
          </p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">카드 구성 (총 36장)</h3>
            ...
            <table className="w-full min-w-[420px] border-collapse text-xs">
              ...
              <tbody>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">1 / 2 / 3 / 4 / 5 / 10 / 15 / 20</td>
                  <td className="px-2 py-1.5">그 숫자만큼 합산</td>
                  <td className="px-2 py-1.5 text-right">26장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">0</td>
                  <td className="px-2 py-1.5">합산에 0으로 반영</td>
                  <td className="px-2 py-1.5 text-right">3장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">-5 / -10</td>
                  <td className="px-2 py-1.5">합산에서 차감</td>
                  <td className="px-2 py-1.5 text-right">2장 / 1장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">🌙 0 (선 교체)</td>
                  <td className="px-2 py-1.5">합산 0, 이 카드를 가진 사람이 다음 라운드의 선이 됩니다</td>
                  <td className="px-2 py-1.5 text-right">1장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">🎁 ?</td>
                  <td className="px-2 py-1.5">덱 맨 위 카드를 추가로 공개해 합산 (또 나오면 계속 뽑음)</td>
                  <td className="px-2 py-1.5 text-right">1장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">👧 MAX→0</td>
                  <td className="px-2 py-1.5">공개된 카드 중 가장 높은 숫자 1장을 0으로 무효화</td>
                  <td className="px-2 py-1.5 text-right">1장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-800">🪶 ×2</td>
        ...
        <section>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-white/15 bg-white/[0.03] p-3 light:border-slate-200 light:bg-white/90 light:shadow-sm">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">① 숫자 선언하기</p>
              <p className="text-xs text-white/60 light:text-slate-500">직전 선언보다 반드시 더 큰 숫자를 불러야 합니다.</p>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/[0.03] p-3 light:border-slate-200 light:bg-white/90 light:shadow-sm">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">② &quot;코요테!&quot; 외치기</p>
              <p className="text-xs text-white/60 light:text-slate-500">직전 선언이 실제 총합보다 크다(오버했다)고 판단되면 외칩니다.</p>
            </div>
          </div>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">정산 (§4)</h3>
