      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-700">
            ...
            <span className="text-fuchsia-300 light:text-fuchsia-700"> 많이 이기는 게 아니라, 정확히 예측한 만큼만 이기는 것</span>이 핵심입니다.
            {playerCount}인 모드, 총 {TOTAL_ROUNDS}라운드로 진행됩니다.
          </p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">카드 구성 (총 {deckSize}장)</h3>
            ...
            <table className="w-full min-w-[380px] border-collapse text-xs">
              ...
              <tbody>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-700">0</td>
                  <td className="px-2 py-1.5">평소엔 가장 약하지만, 데스카드를 만나면 역전승. 리버스 상태에선 가장 강함</td>
                  <td className="px-2 py-1.5 text-right">{zeroCount}장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-700">1 ~ {maxNumber}</td>
                  <td className="px-2 py-1.5">숫자가 클수록 강함 ({reverseLabel}은 리버스 카드 겸용)</td>
                  <td className="px-2 py-1.5 text-right">각 1장</td>
                </tr>
                <tr className="border-t border-white/10 light:border-slate-200">
                  <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-700">💀 데스카드</td>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">라운드 구조 — &quot;라운드 R은 R장, R턴&quot;</h3>
          <p className="text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">카드 공개 순서</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">승부 판정</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-700">
            <li>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">예측 &amp; 히든</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">점수 산식</h3>
          <div className="rounded-xl border border-white/15 bg-white/[0.03] p-3 text-xs text-white/70 light:border-slate-200 light:bg-slate-50 light:text-slate-700">
            <p>
            ...
            <p className="mt-1 text-white/50 light:text-slate-500">9라운드 각각의 점수를 모두 합산한 값이 최종 점수입니다.</p>
          </div>
        </section>
