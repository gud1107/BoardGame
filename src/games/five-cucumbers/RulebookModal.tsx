      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-600">
            ...
            <span className="text-emerald-300 light:text-emerald-700">이 게임의 목표는 트릭을 이기는 게 아니라 — 정확히 그 반대로, 매 라운드의
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">준비</h3>
          <p className="text-white/70 light:text-slate-600">모든 플레이어에게 카드를 7장씩 나눠주고, 한 라운드는 총 7번의 트릭으로 진행됩니다.</p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">트릭 진행 — 카드 내는 규칙</h3>
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-white/15 bg-white/[0.03] light:border-slate-200 light:bg-slate-50 p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">① 선 플레이어</p>
              <p className="text-xs text-white/60 light:text-slate-500">손에 있는 카드 중 아무거나 1장을 내며 트릭을 시작합니다.</p>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/[0.03] light:border-slate-200 light:bg-slate-50 p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">② 다음 플레이어들 — 둘 중 하나만</p>
        ...
        <section>
          ...
          <div className="overflow-x-auto rounded-xl border border-white/10 light:border-slate-200">
            <table className="w-full min-w-[280px] border-collapse text-xs">
              ...
              <tbody>
                {TIER_ROWS.map((row) => (
                  <tr key={row.range} className="border-t border-white/10 light:border-slate-200">
                    <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-700">{row.range}</td>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">탈락 기준 (하우스 룰)</h3>
          <p className="text-white/70 light:text-slate-600">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">전략 팁</h3>
