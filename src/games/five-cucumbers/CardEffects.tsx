...
export function FlyingPlayedCard({
  ...
  return createPortal(
    ...
    >
      <div className="flex h-20 w-14 flex-col items-center justify-between rounded-lg border border-white/40 light:border-slate-300 bg-gradient-to-b from-emerald-800 to-emerald-950 p-1.5 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.8)] light:shadow-md">
  ...
  return createPortal(
    <div ref={elRef} className="pointer-events-none fixed z-[70]" style={{ left: 0, top: 0, opacity: 0 }}>
      <div
        ...
        className="flex h-7 w-7 items-center justify-center rounded-full border border-emerald-300/60 bg-black/70 light:border-emerald-400 light:bg-white/90 shadow-[0_6px_16px_-4px_rgba(0,0,0,0.85)] light:shadow-md"
      >
