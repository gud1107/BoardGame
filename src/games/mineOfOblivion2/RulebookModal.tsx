  ...
  return (
    <Overlay title="🧨 망각의 지뢰 2 룰북" onClose={onClose} wide>
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">🧨 시한폭탄 규칙</h3>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">도착 칸 판정 (1편과 동일)</h3>
          <div className="grid gap-2 sm:grid-cols-3">
            <div className="rounded-xl border border-emerald-400/20 bg-emerald-400/5 p-3">
              <p className="mb-1 font-medium text-emerald-300">🟢 미답사 칸</p>
              <p className="text-xs text-white/60 light:text-slate-600">인접 8칸의 총 지뢰 수만큼 즉시 점수 획득(시한폭탄은 이 숫자에 포함되지 않습니다).</p>
            </div>
            <div className="rounded-xl border border-white/10 light:border-slate-200 bg-white/5 light:bg-slate-900/5 p-3">
              ...
              <p className="text-xs text-white/60 light:text-slate-600">0점, 즉시 다음 차례로 넘어갑니다.</p>
            </div>
            <div className="rounded-xl border border-rose-400/20 bg-rose-400/5 p-3">
              <p className="mb-1 font-medium text-rose-300">💣 지뢰 명중</p>
              <p className="text-xs text-white/60 light:text-slate-600">−5점 후 해당 지뢰 전부 제거, 안전구역 인근으로 강제 리스폰(시한폭탄과 별개 하자드).</p>
            </div>
          </div>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">보물 순차 점수제 · 승리 조건</h3>
          <p className="text-white/70 light:text-slate-700">
