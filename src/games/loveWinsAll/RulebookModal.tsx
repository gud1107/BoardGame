  ...
  return (
    <Overlay title="💗 러브 윈즈 올 룰북" onClose={onClose} wide>
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          <p className="break-keep text-white/70 light:text-slate-700">
          ...
          <p className="mt-2 break-keep text-xs text-white/40 light:text-slate-500">
        ...
        {variant === "base" ? (
          <>
            <section>
              <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">구성물</h3>
              <p className="break-keep text-white/70 light:text-slate-700">
                가위 12장·바위 7장·보 7장·러브 4장(총 30장), 개인 칩 각자 {STARTING_CHIPS.base}개.
              </p>
            </section>
            <section>
              <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">족보표 (숫자가 낮을수록 강함)</h3>
              <ol className="list-decimal space-y-1 pl-5 break-keep text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">라운드 진행 순서</h3>
          <ol className="list-decimal space-y-1.5 pl-5 break-keep text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">무승부 · 폴드 · 승리 조건</h3>
          <p className="break-keep text-white/70 light:text-slate-700">
