      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        ...
        <section>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-white/10 light:border-slate-200 bg-white/5 light:bg-slate-900/5 p-3">
              <p className="mb-1 font-medium text-white light:text-slate-900">➡️ 슬라이드 이동</p>
              <p className="text-xs text-white/60 light:text-slate-600">
                ...
                <span className="text-white/40 light:text-slate-500">
            ...
            <div className="rounded-xl border border-white/10 light:border-slate-200 bg-white/5 light:bg-slate-900/5 p-3">
              <p className="mb-1 font-medium text-white light:text-slate-900">♞ L자 이동 (나이트)</p>
              <p className="text-xs text-white/60 light:text-slate-600">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">
            ...
            <span className="text-white/30 light:text-slate-400 normal-case">(룰북 원문에는 없는 추가 규칙)</span>
          </h3>
          <p className="text-white/70 light:text-slate-700">
