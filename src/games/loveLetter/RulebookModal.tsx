  ...
  return (
    <Overlay title="📖 러브레터(Love Letter) 룰북" onClose={onClose} wide>
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">목표 (단판 승부)</h3>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">카드 구성 (총 16장)</h3>
          <div className="overflow-x-auto rounded-xl border border-white/10 light:border-slate-200">
            <table className="w-full min-w-[520px] border-collapse text-xs">
              <thead>
                <tr className="bg-white/5 light:bg-slate-900/5 text-white/50 light:text-slate-500">
              ...
              <tbody>
                {[
                  ...
                  <tr key={n as number} className="border-t border-white/10 light:border-slate-200">
                    ...
                    <td className="px-2 py-1.5 font-semibold whitespace-nowrap text-white/80 light:text-slate-700">
                      {n}. {name}
                    </td>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">세팅</h3>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">내 턴에 하는 행동 (2단계)</h3>
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-white/15 light:border-slate-200 bg-white/[0.03] p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-800">① 카드 뽑기</p>
              <p className="text-xs text-white/60 light:text-slate-600">덱 맨 위에서 1장을 가져와 손에 2장을 듭니다.</p>
            </div>
            <div className="rounded-xl border border-white/15 light:border-slate-200 bg-white/[0.03] p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-800">② 카드 내기</p>
              <p className="text-xs text-white/60 light:text-slate-600">2장 중 1장을 앞면으로 내려놓고 효과를 즉시 적용합니다.</p>
            </div>
          </div>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">지목 불가능 상황</h3>
          <p className="text-xs text-white/70 light:text-slate-700">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">라운드(=게임) 종료</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-700">
            <li>
