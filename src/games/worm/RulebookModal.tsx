      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-600">
            ...
            <span className="text-lime-300 light:text-lime-700">누적 점수</span>가 가장 높은 지렁이가 승리합니다.
          </p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">조작법</h3>
          <ul className="list-disc space-y-1.5 pl-4 text-white/70 light:text-slate-600">
            ...
            <li>
              <b>모바일</b>: 화면 좌측 세로 중앙 가상 조이스틱을 드래그해 방향을 조절하고, 우측 세로 중앙 🚀
              버튼을 눌러 부스터를 씁니다.
            </li>
          </ul>
        </section>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">핵심 메커니즘</h3>
          <ol className="list-decimal space-y-1.5 pl-4 text-white/70 light:text-slate-600">
            <li>
              ...
              점수가 오릅니다. 길이가 10·25·50·100마디를 넘어설 때마다 마디 형태(가시 돌기 → 비늘 네온
              글로우 → 크리스탈 → 오로라 펄스)와 색상이 단계적으로 화려하게 진화하며, 그 순간 몸 전체를
              머리부터 꼬리까지 훑는 빛의 파동이 재생됩니다.
            </li>
            <li>
            ...
            <li>
              ...
              같으면 둘 다 죽지 않고 각자 꼬리 1마디만 잃습니다. 상대를 처치하면 2.5초 동안 내 머리가
              사악한 미소·윙크·선글라스 중 하나로 랜덤 전환되는 승리 표정을 짓고, 짧은 진동과 함께 화면
              중앙에 &quot;처치! / ELIMINATED!&quot; 배너가 뜹니다.
            </li>
            <li>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">HUD & 리더보드</h3>
          <p className="text-white/70 light:text-slate-600">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 uppercase light:text-slate-500">종료 & 승리</h3>
          <p className="text-white/70 light:text-slate-600">
