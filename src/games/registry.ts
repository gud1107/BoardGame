...
export const GAME_REGISTRY: GameMeta[] = [
  ...
  },
  {
    ...
    description:
      "9라운드 동안 매 라운드 자신의 승수를 예측하는 심리·확률 카드 게임. 라운드 R마다 카드 R장을 받아 R번의 턴으로 승부하며, 0/데스카드/리버스 카드가 뒤엉킨 승부 속에서 많이 이기는 게 아니라 정확히 예측한 만큼만 이겨야 점수를 얻습니다. 5인(45장 덱, 리버스 11·22·33) 또는 8인(72장 덱, 리버스 11·22·33·44·55) 모드 중 선택해 플레이합니다.",
    players: { min: 5, max: 8 },
