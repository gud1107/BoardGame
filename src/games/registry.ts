...
export const GAME_REGISTRY: GameMeta[] = [
  ...
  },
  {
    ...
    description:
      "넷플릭스 예능 <데스게임> 등장 2인 전용 두뇌·베팅 심리전. 매 라운드 가림판 뒤에서 2~6개의 코인을 비공개로 판돈에 걸고, 포커식 콜·레이즈·폴드로 판돈을 키운 뒤 동시에 공개해 더 많은 코인을 걸었던 쪽이 판돈을 독식합니다. 상대의 코인을 0개로 만들면 즉시 승리하는 서바이벌 단판 승부입니다.",
    players: { min: 2, max: 2 },
    playTime: { minMinutes: 15, maxMinutes: 30 },
    category: "deduction",
  ...
  },
  {
    ...
    description:
      "넷플릭스 예능 <데스게임> 등장 2인 전용 심리·배신 데스매치. 가림판 뒤에서 LOVE(협력) 또는 WAR(배신) 중 하나를 비공개로 골라 동시에 공개합니다. 둘 다 LOVE면 무승부로 판돈이 이월되어 재경기, 한쪽만 WAR면 그 사람이 판돈을 독식하며 단독 승리, 둘 다 WAR면 둘 다 최종 패배하는 단판 승부 죄수의 딜레마입니다.",
    players: { min: 2, max: 2 },
    playTime: { minMinutes: 10, maxMinutes: 20 },
    category: "deduction",
    thumbnail: { emoji: "💕", gradient: ["#ec4899", "#1a0510"] },
    tags: ["2인전용", "심리전", "배신", "단판승부", "데스게임"],
    genres: ["bluffing", "strategy"],
    collectionId: "netflix-death-game",
    playable: true,
    supportsAutoRanking: true,
