...
export const GAME_REGISTRY: GameMeta[] = [
  ...
  {
    id: "lotr-duel",
    name: "반지의 제왕: 가운데땅에서의 대결",
    nameEn: "The Lord of the Rings: Duel for Middle-earth",
    description:
      "사우론의 군세와 반지 원정대의 운명을 건 2인 결전! 3챕터 피라미드 카드 드래프트로 기술·종족·군사·재정·반지 카드를 모으고, 7개 지역에 유닛과 요새를 펼치세요. 반지 원정(운명의 산 도달·나즈굴 추격), 6종족 동맹, 7개 지역 완전 정복 중 하나를 먼저 이루면 즉시 승리합니다.",
    players: { min: 2, max: 2 },
    playTime: { minMinutes: 30, maxMinutes: 45 },
    category: "strategy",
    thumbnail: { emoji: "💍", gradient: ["#f59e0b", "#0b0a10"] },
    tags: ["2인전용", "피라미드드래프트", "반지원정", "지역장악"],
    genres: ["strategy"],
    playable: true,
    supportsAutoRanking: true,
    onlineMultiplayer: true,
  ...
  },
  {
    ...
    nameEn: "Mafia",
    description:
      "시민과 마피아로 나뉘어 밤과 낮을 오가며 서로를 추리하고 설득하는 국민 파티 게임. 기본룰(4~8인, 마피아/경찰/의사/시민)과 확장룰(6~12인, 스파이/군인/정치인/영매/테러리스트 추가) 중 골라 방을 만들 수 있으며, 사망자는 즉시 유령 관전 모드로 전환되어 전체 직업을 지켜보고 전용 채팅을 씁니다.",
  ...
  },
  {
    ...
    playTime: { minMinutes: 15, maxMinutes: 25 },
    category: "party",
    thumbnail: { emoji: "🐺", gradient: ["#f97316", "#7c2d12"], image: "/games/coyote.jpg" },
    tags: ["블러핑", "심리전", "파티"],
    genres: ["bluffing", "party"],
    playable: true,
    supportsAutoRanking: true,
  ...
  },
  {
    ...
    playTime: { minMinutes: 15, maxMinutes: 30 },
    category: "deduction",
    thumbnail: { emoji: "👑", gradient: ["#f59e0b", "#78350f"], image: "/games/coup.webp" },
    tags: ["블러핑", "심리전", "단판승부"],
    genres: ["bluffing", "strategy"],
    playable: true,
    supportsAutoRanking: true,
  ...
  },
  {
    id: "show-me-the-coin",
    name: "쇼미더코인",
    nameEn: "Show Me The Coin",
    description:
      "넷플릭스 예능 <데스게임> 등장 2인 전용 두뇌·베팅 심리전. 매 라운드 앤티를 낸 뒤 가림판 뒤에서 2~6개의 숫자 코인을 비공개로 고르고, 포커식 체크·콜·레이즈·올인·폴드로 베팅칩 판돈을 키운 뒤 동시에 공개해 코인 합산 금액이 더 높은 쪽이 판돈을 독식합니다. 제출한 코인은 승패와 상관없이 영구 소멸되며, 베팅칩이 바닥나거나 낼 코인이 없으면 즉시 탈락하는 서바이벌 단판 승부입니다.",
    players: { min: 2, max: 2 },
    playTime: { minMinutes: 15, maxMinutes: 30 },
    category: "deduction",
    thumbnail: { emoji: "🪙", gradient: ["#f59e0b", "#1a0b12"] },
    tags: ["2인전용", "베팅", "블러핑", "단판승부", "데스게임"],
    genres: ["bluffing", "luck"],
    collectionId: "netflix-death-game",
    playable: true,
    supportsAutoRanking: true,
  ...
  },
  {
    id: "love-wins-all",
    name: "러브 윈즈 올",
    nameEn: "Love Wins All",
    description:
      "가위·바위·보에 러브 카드가 더해진 2인 전용 칩 베팅 심리전. 콜/레이즈/폴드로 베팅하고, 카드 1장을 공개하며 블러핑 섞인 족보 선언을 주고받은 뒤 전체 공개로 승부를 가립니다. 상대의 칩을 모두 가져오면 승리하는 노리밋 포커식 데스매치이며, 방장이 시즌2 개선판(커뮤니티 카드+라이어 카드) 룰로도 전환할 수 있습니다.",
    players: { min: 2, max: 2 },
    playTime: { minMinutes: 10, maxMinutes: 20 },
    category: "deduction",
    thumbnail: { emoji: "💗", gradient: ["#ec4899", "#1a0510"] },
    tags: ["2인전용", "심리전", "베팅", "블러핑", "데스게임"],
    genres: ["bluffing", "strategy"],
    collectionId: "netflix-death-game",
    playable: true,
    supportsAutoRanking: true,
  ...
  },
  {
    id: "rat-a-tat-cat",
    name: "랫어탯캣",
    nameEn: "Rat-a-Tat Cat",
    description:
      "2~6인 기억력·블러핑 카드 게임. 4장의 카드를 뒷면으로 받아 양 끝 2장만 몰래 확인한 뒤, 매 턴 덱이나 버림 더미에서 카드를 가져와 교체하거나 엿보기·바꾸기·두 번 뽑기 특수 카드를 활용합니다. \"랫어탯캣!\"을 외치면 나머지 전원이 마지막 1턴씩 진행한 뒤 카드 합이 가장 낮은 사람이 승리하는 단판 승부.",
    players: { min: 2, max: 6 },
    playTime: { minMinutes: 10, maxMinutes: 20 },
    category: "card",
    thumbnail: { emoji: "🐱", gradient: ["#fbbf24", "#3f2d0a"] },
    tags: ["카드", "기억력", "블러핑", "단판승부", "가족게임"],
    genres: ["strategy", "family"],
    playable: true,
    supportsAutoRanking: true,
    onlineMultiplayer: true,
  ...
  },
  {
    id: "great-legacy",
    name: "위대한 투자",
    nameEn: "The Great Investment",
    description:
      "전 세계 3대 시장(국장·미장·코인)의 핵심 자산을 놓고 벌이는 심리 경매 게임. 신용대출 코인을 입찰해 자산 카드를 낙찰받고 포트폴리오 시너지를 완성해 점수를 쌓되, 악재/어닝쇼크·상장폐지·강제반대매매 카드는 거꾸로 '먼저 포기한 사람'이 떠안는 역경매입니다. 4인은 원작 그대로, 8인은 완전 리밸런싱된 단일 테이블 변형입니다.",
    players: { min: 4, max: 8 },
    playTime: { minMinutes: 30, maxMinutes: 50 },
    category: "card",
    thumbnail: { emoji: "📈", gradient: ["#f59e0b", "#7c2d12"] },
    tags: ["경매", "심리전", "컬렉션"],
    genres: ["strategy", "bluffing"],
    playable: true,
    supportsAutoRanking: true,
