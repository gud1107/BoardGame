      ...
      <div className="flex flex-col gap-5 text-sm text-white/80 light:text-slate-700">
        <section>
          ...
          <p className="text-white/70 light:text-slate-600">
            부동산 중개인이 되어 두 단계로 겨룹니다. <span className="text-sky-300 light:text-sky-700">1단계: 매수</span>에서는 부동산
            카드를 경매로 최대한 저렴하게 확보하고, <span className="text-emerald-300 light:text-emerald-700">2단계: 매도</span>에서는
            확보한 부동산을 팔아 수표(돈)를 얻습니다. 수표 총액과 남은 동전을 합쳐 가장 부유한 사람이 승리합니다.
          </p>
        </section>

        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">구성품</h3>
          ...
          <div className="mt-2 overflow-x-auto rounded-xl border border-white/10 light:border-slate-200">
            <table className="w-full min-w-[380px] border-collapse text-xs">
              ...
              <tbody>
                {[3, 4, 5, 6].map((n) => (
                  <tr key={n} className="border-t border-white/10 light:border-slate-200">
                    <td className="px-2 py-1.5 font-semibold text-white/80 light:text-slate-700">{n}명</td>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">1단계: 부동산 경매</h3>
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-white/15 bg-white/[0.03] light:border-slate-200 light:bg-slate-50 p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">💰 입찰(Bid)</p>
              <p className="text-xs text-white/60 light:text-slate-500">현재 입찰가보다 최소 $1,000 이상 높은 금액을 부릅니다.</p>
            </div>
            <div className="rounded-xl border border-white/15 bg-white/[0.03] light:border-slate-200 light:bg-slate-50 p-3">
              <p className="mb-1 font-medium text-white/90 light:text-slate-900">🙅 포기(Pass)</p>
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">2단계: 수표 판매</h3>
          <p className="text-xs text-white/60 light:text-slate-500">
        ...
        <section>
          <h3 className="mb-2 text-xs font-semibold tracking-wide text-white/50 light:text-slate-500 uppercase">최종 점수 계산</h3>
          <ul className="list-disc space-y-1 pl-4 text-xs text-white/70 light:text-slate-600">
