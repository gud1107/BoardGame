...
// ---------------------------------------------------------------------------
// Ring track (self-designed lengths — the rulebook gives no space count)
// ---------------------------------------------------------------------------

/** Mount Doom. The track is drawn as 4 assembled pieces of equal length. */
export const TRACK_LENGTH = 15;
/** Frodo & Sam start ahead of the Nazgûl so the chase isn't over on turn one. */
export const FRODO_START = 5;
