...
export default function SupabaseRequiredNotice({ feature }: { feature: string }) {
  return (
    <div className="mx-auto flex max-w-md flex-col items-center gap-3 rounded-2xl border border-amber-400/30 bg-amber-500/10 p-6 text-center light:border-amber-300 light:bg-amber-50">
      <h2 className="text-lg font-bold text-white light:text-slate-900">{feature}을(를) 사용할 수 없어요</h2>
      <p className="text-sm text-amber-100/80 light:text-amber-800">
