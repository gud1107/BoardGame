...
- **적용 상태**: 포세일·코요테·라스베가스·그리드 포커·소환사의 협곡 5종(2026-08-13 신규 적용, HANDOFF.md 참고). 하나미코지·노땡스·페루도·스플렌더 4종은 봇은 있지만 아직 레벨이 없다(§7.1 시그니처 그대로 — 다음에 만지는 세션에서 `pickByLevel`로 리팩터링).
