...
| **클라우드 백엔드(선택)** | Supabase — Realtime(Broadcast/Presence)으로 7개 온라인 대전 게임 필수, Postgres 2테이블로 기기 간 식별 매칭·내기 기록 백업(선택) |
...
| 테스트 | Vitest, **272개 전부 통과** (게임 엔진 7종 유닛 테스트만 — UI 컴포넌트 테스트 없음, 아래 "기억할 것 하나" 참고) |
| 실제 플레이 가능 게임 | 하나미코지 · 뱅! · 그리드 포커 · 아발론 · 노땡스(No Thanks!) · 페루도(Perudo) · 센추리(Century: Spice Road) (총 21종 카탈로그 중 7종, 나머지는 "준비중") |
...
| [features.md](./features.md) | 대시보드/카탈로그, 내기 정산 시스템, 플레이어 식별, 7개 게임 각각의 룰 해석 판단 기록 |
...
- `boardGameRule/*.md` — 게임별 공식 룰 원문(Avalon.md, bang.md, Grid Poker.md, noThanks.md, Perudo.md, Century.md) — 엔진 구현의 근거 자료
